...
omnitest <- function(correctExpr=NULL, correctVal=NULL, strict=FALSE){
  ...
  if(valGood && exprGood){
    ...
    swirl_out("To nie do końca to o co mi chodziło, ale działa.")
    swirl_out("Wykonałem wyrażenie z prawdiłową odpowiedzią, w razie gdyby było to wymagane przez następne pytania.")
